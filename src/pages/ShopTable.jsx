...
const ShopSofa = () => {
  ...
  data = data.filter((item) => item.product === "table");
  console.log(data);
  ...
  return (
    <div className="shop-wrap">
      <ShopTop category="table"/>
      <div className="inner">
        <div className="product-filter">
          <div className="filter-title">
            <p className='product-sort'>Table</p>
            <p className="arrow"><img src="/images/product-icon.png" alt="" /></p>
            <div className="select-material">
              <p onClick={() => { setSelectedSubCate("Dining"); setCurrentpage(1); }}
                className={selectedSubCate === "Dining" ? "active" : ""}
              >Dining</p>
              <p onClick={() => { setSelectedSubCate("Lounge"); setCurrentpage(1); }}
                className={selectedSubCate === "Lounge" ? "active" : ""}
              >Lounge</p>
              <p onClick={() => { setSelectedSubCate("Bench"); setCurrentpage(1); }}
